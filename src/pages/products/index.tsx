...
import { getProducts } from "@/utils/bakolApi";
                ...
                <div className="flex flex-row flex-wrap gap-4 py-5">
                    {
                        ...
                        products.map((product, i) => {
                            return (
                                <Link href={`#${product.sku}`} id={product.sku} key={i} className="hover:scale-105 transition-all transform group">
                                            ...
                                            <div className="text-sm">
                                                {
                                                    ...
                                                    <span>Rp{Intl.NumberFormat('id-ID').format(product.discounted_price)}</span> 
                                                    : 
